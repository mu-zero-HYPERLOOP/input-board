...
public:
  ...
  isolated_voltage_meas(const Resistance &r1, const Resistance &r2) {
    return AnalogConfig(tag::ISOLATED_VOLTAGES, 0_Ohm, r1, r2, 0_V);
  }
  
  [[maybe_unused]] static constexpr AnalogConfig none() {
    return AnalogConfig(tag::NONE, 0_Ohm, 0_Ohm, 0_Ohm, 0_V);
  }
