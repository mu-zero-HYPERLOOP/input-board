...
static DMAMEM ErrorLevelRangeCheck<EXPECT_OVER>
    supercap_under_volt_check(canzero_get_supercap_voltage,
...
static DMAMEM ErrorLevelRangeCheck<EXPECT_UNDER>
    supercap_over_volt_check(canzero_get_supercap_voltage,
...
void FLASHMEM sensors::supercap_voltage::begin() {
  ...
  canzero_set_supercap_voltage_calibration_offset(static_cast<float>(DEFAULT_OFFSET));
