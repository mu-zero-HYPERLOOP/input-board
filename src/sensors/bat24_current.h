...
constexpr Resistance VOLT_PER_AMP = 99_mV / 1_A;
constexpr Current ZERO_A_READING = -26.25_A;

// constexpr Resistance R1_V_DIV = 620_Ohm; //588_Ohm
// constexpr Resistance R2_V_DIV = 1200_Ohm; // 1134_Ohm

constexpr Resistance R1_V_DIV = 590_Ohm;
constexpr Resistance R2_V_DIV = 1135_Ohm; 
